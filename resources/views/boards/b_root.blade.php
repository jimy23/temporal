...
<div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav side-nav">
        ...
        <li>
            <a href="#"><i class="fa fa-male fa-lg" aria-hidden="true"></i><i class="fa fa-female fa-lg"
                                                                              aria-hidden="true"></i> USUARIOS</a>
        </li>
        <li>
            <a href="#"><i class="fa fa-fw fa-check-square-o fa-lg" aria-hidden="true"></i> SOLICITUDES</a>
        </li>
